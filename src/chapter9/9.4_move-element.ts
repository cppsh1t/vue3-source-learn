...
export const rendererItem: RendererItem = {
    ...
    doRender: function () {
        ...
        const oldVNode: VNode = {
            type: 'div',
            children: [
                { type: 'p', children: '1 to 2', key: 1 },
                { type: 'p', children: '2 to 3', key: 2 },
                { type: 'p', children: 'hello 3 to 1', key: 3 },
            ],
        }
        ...
        const newVNode: VNode = {
            type: 'div',
            children: [
                { type: 'p', children: 'world now 1', key: 3 },
                { type: 'p', children: '1 now 2', key: 1 },
                { type: 'p', children: '2 now 3', key: 2 },
            ],
        }
