...
function watch<T>(getter: () => T, cb: (newValue: T, oldValue: T) => void, options?: WatchOption): void
function watch<T>(source: T, cb: (newValue: T, oldValue: T) => void, options?: WatchOption): void

function watch(source: any, cb: (newValue: any, oldValue: any) => void, options: WatchOption = {}) {
    // 定义getter
    let getter: () => any
